...
import org.atxhackerspace.security.auth.login.AccountLockedException;
import org.atxhackerspace.security.auth.login.CredentialException;
import org.atxhackerspace.security.auth.login.CredentialExpiredException;
import org.atxhackerspace.security.auth.login.CredentialNotFoundException;
...
public class Wiki implements Serializable
{
    ...
    public Revision[] contribs(String user, String prefix, Calendar end, Calendar start, int... ns) throws IOException
    {
        ...
        log(Level.INFO, "Successfully retrived contributions for " + ((prefix.length() == 0) ? user : prefix) + " (" + size + " edits)", "contribs");
